...
ifdef::badges[]
image:https://shields.io/docker/pulls/antora/antora[pulls]
image:https://shields.io/docker/v/antora/antora/latest[latest,link=https://hub.docker.com/r/antora/antora/tags?name=latest]
image:https://shields.io/docker/v/antora/antora/testing[testing,link=https://hub.docker.com/r/antora/antora/tags?name=testing]
endif::[]
